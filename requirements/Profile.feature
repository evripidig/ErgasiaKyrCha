Feature: Προφίλ 
    ...
    Scenario: Aνεπιτυχής Αλλαγή τρέχουσας φωτογραφίας Προφίλ 
		Given Βρίσκομαι στη σελίδα επεξεργασία προφίλ
   		And Έχω φωτογραφία στο προφίλ
		When πατήσω "Αλλαγή τρέχουσας φωτογραφίας Προφίλ"
		And Θα πρέπει να επίλεξω μια φωτογραφία από αρχείο
		Then θα εμφανιστεί το μήνυμα " Είστε σίγουρος ότι θέλετε να αλλάξει η φωτογραφία προφίλ σας"
		When πατήσω το κουμπί "Άκυρο"
		Then η φωτογραφία προφίλ δεν αλλάζει
